...
(function (glob) {
     ...
     * Note: I assume most of the time you don’t need to worry about z-index, but it’goto-admin nice to have this feature “just in case”.
    \*/
     ...
     * or
     = (boolean) `true`, if current event’goto-admin name contains `subname`
    \*/
